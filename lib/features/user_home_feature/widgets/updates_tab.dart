...
class UsersUpdatesTab extends StatefulWidget {
  const UsersUpdatesTab({
    super.key,
  });

  @override
  State<UsersUpdatesTab> createState() => _UsersUpdatesTabState();
}

class _UsersUpdatesTabState extends State<UsersUpdatesTab> {
            ...
            child: Row(
              children: [
                DropdownButton<String>(
                  ...
                  items:
                      <String>['All Updates', 'My Updates'].map((String value) {
